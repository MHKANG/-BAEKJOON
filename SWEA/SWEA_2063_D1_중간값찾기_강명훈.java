...
public class SWEA_2063_D1_중간값찾기_강명훈 {
	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in);
		//scanner = new Scanner(src);
		int T = scanner.nextInt();
		int mid_index = T/2;
		int[] Score_Array = new int [T]; 
		for (int i = 0; i < T; i++)
		{
				Score_Array[i] = scanner.nextInt();
		}
		//Bubble Sort 
		for(int i = Score_Array.length; i > 0; i--)
		{
			for(int j = 0; j < i-1; j++)
			{
				int temp ;
		...
		System.out.println(Score_Array[mid_index]);
	}
	/*
	public static String src = "199\r\n" + 
